...
public class AlgorithmPoolFactory {
    private static final AlgorithmRegistry[] ALGORITHMS = {
        ...
        new AlgorithmRegistry("ExponentialSmoothing", ExponentialSmoothingAlgorithm.class),
        new AlgorithmRegistry("ProbabilityDistribution", ProbabilityDistributionAlgorithm.class),
        new AlgorithmRegistry("KNearestNeighbors", KNearestNeighborsAlgorithm.class),
        new AlgorithmRegistry("SeasonalMovingAverage", SeasonalMovingAverageAlgorithm.class),
        ...
        new AlgorithmRegistry("SVMSimulation", SVMSimulationAlgorithm.class),
