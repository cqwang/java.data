...
import cqwang.doubleball.detection.algorithm.singleball.SingleBallAlgorithmRegistryFactory;
import cqwang.doubleball.detection.algorithm.singleball.SingleBallPredictAlgorithmRegistry;
...
public class DoubleColorPredictionAlgorithmRegistry extends AlgorithmRegistry implements DoubleColorPredictionAlgorithm {
    ...
    public DoubleColorBall predict(int targetIndex, PredictOption predictOption) {
        ...
        for (int redIndex = 0; redIndex < 6; redIndex++) {
            ...
            int predictRed = redAlgorithm.predict(singleBall, redRange, new StrategyOption(predictOption.getRed(redIndex))).getResult();
